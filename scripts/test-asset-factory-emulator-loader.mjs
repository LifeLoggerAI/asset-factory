...
const studioRoot = process.cwd().endsWith('assetfactory-studio')
  ? process.cwd()
  : path.join(process.cwd(), 'assetfactory-studio');
...
for (const [specifier, legacyPath] of mappings) {
...
await import('./test-asset-factory-emulator.mjs');
