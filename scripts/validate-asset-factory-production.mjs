...
function validateManifestObject(asset, label) {
  ...
  if ((asset.visibility === 'public-demo' || asset.visibility === 'public-marketing') && asset.permissions?.containsUserData === true) errors.push(`${label}: public asset contains user data`);
