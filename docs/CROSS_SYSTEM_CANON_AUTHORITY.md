...
Repository role: **asset governance and production authority**
...
- Asset existence is not Gold Master certification.
- Rights/provenance/vendor state must remain explicit.
- Spatial exact-head and final visual acceptance govern promotion into launch surfaces.
...
- future source code may exist only under the repo's approved hard-off/fail-closed boundary.
