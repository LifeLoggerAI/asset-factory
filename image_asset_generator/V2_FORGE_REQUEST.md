...
This request is pinned to the current Asset Factory `main` baseline. Fail closed if provider credentials, billing, quality thresholds, promotion credentials, or handoff certification are unavailable.

V1 remains locked. This request does not modify V1 assets or claim V3/XR hardware proof.
